...
<input type="text" class="form-control" name="title" placeholder="Заголовок" value="<?php echo e($task->title ?? $_POST['title']); ?>"  />
<br />

<label for="">Тело</label>
<textarea class="form-control" name="body" placeholder="Тело" rows="5" ><?php echo e($task->body ?? $_POST['body']); ?></textarea>
<br />
...
<select class="form-control" name="parent_id">
    ...
    <?php echo $__env->make('partials.tasks', ['tasks' => $tasks], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</select>
